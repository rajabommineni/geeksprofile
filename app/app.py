...
app.config['MYSQL_DB'] = os.environ.get('DB_DATABASE', 'geekprofile')

email_server = os.environ.get('EMAIL_SERVER', 'localhost')
email_server_port = os.environ.get('EMAIL_SERVER_PORT', '5000')
...
def email():
	if 'loggedin' in session:
		msg = requests.get('http://{}:{}'.format(email_server, email_server_port))
		return render_template('email.html', msg=msg.text)	
